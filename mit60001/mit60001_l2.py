...
#### DECOMPOSITION AND ABSTRACTION ###3
#### NONE OF US KNOWS HOW A PROJECTOR WORKS, LIKE A BLACKBOX, BUT WE USE IT IN ANY CASE
### ABSTRACTION --- YOU DON'T NEED TO KNW HOW THE PROJECTION WORKS
### DECOMPOSITION, IF WE WANT TO PROJECT ONTO A VERY LARGE FIELD, WE CAN TAKE BUNC OF SMALLER PROJECTION
### FEED DIFFERENT INPUT TO EACH OTHER AND WORKING THEM TOGETHER. IDEA OF DECOMPOSITION !!!
## CREATING STRUCTURE IN YOUR CODE IS DECOMPOSITION, TO ACHIEVE THAT, YOU DIVIDE THEM INTO DIFFERENT MODULES

## THEY ARE SELF-CONTAINED, REUSABLE, KEEP CODE ORGANIZED AND COHERENT
## ABSTRACTION IS IDEA OF SUPPRESSING DETAILS: FUNCTION SPECIFICATIONS OR DOCSTRINGS. 
## FUNCTIONS ARE "CALLED" OR "INVOKED" : HAS A NAME, PARAMETERS, DOCSTRING, BODY, AND RETURNS STH
